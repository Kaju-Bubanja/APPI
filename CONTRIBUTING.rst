...
Welcome to ``appi`` contributor's guide.
...
If you experience bugs or general issues with ``appi``, please have a look
...
You can help improve ``appi`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``appi`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``appi``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/appi.git
    cd appi
...
#. Install |pre-commit|_::
   ...
   ``appi`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/appi
.. _issue tracker: https://github.com/<USERNAME>/appi/issues
.. <-- end -->
